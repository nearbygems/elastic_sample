...
import kz.nearbygems.elastic.models.enums.TriggerType;
...
public class TriggerServiceImplTest extends CatalogApplicationTests {
  ...
  void loadById() {
    ...
    assertThat(record.triggerType).isEqualTo(document.triggerType);
    ...
    assertThat(record.isActive).isEqualTo(document.isActive);
  ...
  void save() {
    ...
    final var record = rndTriggerRecord();
    ...
    assertThat(document.triggerType).isEqualTo(record.triggerType);
    ...
    assertThat(document.isActive).isEqualTo(record.isActive);
