...
public class DatamartServiceImplTest extends CatalogApplicationTests {
  ...
  void loadById() {
    ...
    assertThat(record.schedule).isEqualTo(document.schedule);
    assertThat(record.path).isEqualTo(document.path);
    assertThat(record.gitUrl).isEqualTo(document.gitUrl);
    assertThat(record.confluenceUrl).isEqualTo(document.confluenceUrl);
  ...
  void save() {
    ...
    final var record = rndDatamartRecord();
    ...
    assertThat(document.schedule).isEqualTo(record.schedule);
    assertThat(document.path).isEqualTo(record.path);
    assertThat(document.gitUrl).isEqualTo(record.gitUrl);
    assertThat(document.confluenceUrl).isEqualTo(record.confluenceUrl);
  ...
  private DatamartRecord rndDatamartRecord() {
    ...
    record.schedule        = RND.str(4);
    record.path            = RND.str(4);
    record.gitUrl          = RND.str(4);
    record.confluenceUrl   = RND.str(4);
